...
namespace DonDatHang.aspx
{
    public partial class DonDatHang : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //khởi tạo dữ liệu
                ddlLB.Items.Add(new ListItem("Bánh ngọt", "01"));
                ddlLB.Items.Add(new ListItem("Bánh kem", "02"));
                ddlLB.Items.Add(new ListItem("Bánh creep", "03"));
                ddlLB.Items.Add(new ListItem("Bánh trái cây", "04"));
            }
        }
